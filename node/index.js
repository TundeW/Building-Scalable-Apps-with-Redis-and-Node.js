...
class Logger extends EventEmitter {
    constructor(filePath){
        ...
        this._listenForEvent('data-is-ready');
    }
        ...
        this.on(eventName, (data) => {
            ...
            switch(eventName){
                ...
                case 'readLogs': this._readMsgFromFile(); 
                                console.log(`###########  EVENT ${eventName} HANDLED`);
                                break;
                case 'data-is-ready': console.log(`########### Data received successfully. Event: ${eventName}`, data);
                                      break;
                default: break;
            }
...
// client.on('data-is-ready', (data) =>{
//     console.log('########### Data received successfully. Event: data-is-ready', data)
// })